...
public class NetworkUtils {
    ...
    static {
        errorMap.put(ERROR_CODE_NONET, App.Companion.getInstance().getString(R.string.net_error_10001));
        errorMap.put(ERROR_CODE_OUTTIME, App.Companion.getInstance().getString(R.string.net_error_10002));
        errorMap.put(ERROR_CODE_ANALY, App.Companion.getInstance().getString(R.string.net_error_10003));
    }
    ...
    public static boolean isNetWorkAvailable() {
        ConnectivityManager manager = (ConnectivityManager) App.Companion.getInstance()
