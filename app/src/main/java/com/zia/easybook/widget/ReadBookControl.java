...
import com.zia.easybook.App;
import com.zia.easybook.utils.BitmapUtil;
import com.zia.easybook.utils.MeUtils;
...
import static com.zia.easybook.widget.PageLoader.DEFAULT_MARGIN_WIDTH;
...
public class ReadBookControl {
    ...
    private ReadBookControl() {
        preferences = App.Companion.getConfigPreferences();
        initTextDrawable();
    ...
    private void initPageStyle() {
        ...
        if ((bgCustom == 2 || bgCustom == 3) && getBgPath(textDrawableIndex) != null) {
            ...
            if (bgCustom == 2) {
                ...
                bgBitmap = MeUtils.getFitAssetsSampleBitmap(App.Companion.getInstance().getAssets(), bgPath, width, height);
            }
            if (bgBitmap != null) {
                return;
            }
    ...
    private boolean getIsNightTheme() {
        return App.Companion.getInstance().isNightTheme();
    }
    ...
    private int getScreenBrightness() {
        int value = 0;
        ContentResolver cr = App.Companion.getInstance().getContentResolver();
        try {
