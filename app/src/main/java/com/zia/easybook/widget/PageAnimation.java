...
public abstract class PageAnimation {
     ...
     */
    public enum Mode {
        COVER(App.Companion.getAppResources().getString(R.string.page_mode_COVER)),
        SIMULATION(App.Companion.getAppResources().getString(R.string.page_mode_SIMULATION)),
        SLIDE(App.Companion.getAppResources().getString(R.string.page_mode_SLIDE)),
        SCROLL(App.Companion.getAppResources().getString(R.string.page_mode_SCROLL)),
        NONE(App.Companion.getAppResources().getString(R.string.page_mode_NONE));
