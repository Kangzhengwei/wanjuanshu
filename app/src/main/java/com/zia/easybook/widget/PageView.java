...
import com.zia.easybook.ReadActivity;
import com.zia.easybook.utils.ImmersionBar;
...
import static com.zia.easybook.utils.ScreenUtils.getDisplayMetrics;
...
public class PageView extends View implements PageAnimation.OnPageChangeListener {
     ...
     * 获取 PageLoader
     */
    public PageLoader getPageLoader(ReadActivity activity, Book book, Catalog catalog, PageLoader.Callback callback) {
        ...
        // 根据书籍类型，获取具体的加载器
        mPageLoader = new PageLoaderNet(this, book, catalog, callback);
